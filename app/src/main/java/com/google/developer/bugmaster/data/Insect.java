...
public final class Insect implements Parcelable {
    ...
    public Insect(Cursor cursor) {
      ...
      /*  this.name = null;
        ...
        this.dangerLevel = -1;*/
        this.name = cursor.getString(cursor.getColumnIndex(BugsContract.BugEntry.COLUMN_NAME));
        this.scientificName = cursor.getString(cursor.getColumnIndex(BugsContract.BugEntry.COLUMN_SCIENTIFICNAME));
        this.classification = cursor.getString(cursor.getColumnIndex(BugsContract.BugEntry.COLUMN_CLASSIFICATION));
        this.imageAsset = cursor.getString(cursor.getColumnIndex(BugsContract.BugEntry.COLUMN_IMAGEASSET));
        this.dangerLevel = Integer.parseInt(cursor.getString(cursor.getColumnIndex(BugsContract.BugEntry.COLUMN_DANGERLEVEL)));
    }
